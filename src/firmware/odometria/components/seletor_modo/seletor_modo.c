...
static void play_tone(uint32_t freq, uint32_t duracao_ms)
{
...
void seletor_modo_init(TaskHandle_t supervisor)
{
    ...
    // o servico de ISR pode ja ter sido instalado por outro modulo; ignoramos
    // o erro de "ja instalado" propositalmente.
